...
/**
* \brief The entry point for the Inference Engine social_distancing_demo application
* \file osocial_distancing_demo/main.cpp
* \example social_distancing_demo/main.cpp
*/
